...
namespace MomocloNews.ViewModels
{
    public class PreferencesPageViewModel : ViewModelBase<PreferencesPageViewModel>
    {
        ...
        public PreferencesPageViewModel(PhoneApplicationFrame app, INavigator navigator, IMomocloNewsService service, FeedDataContext dataContext)
        {
            this.app = app;
        ...
        private void RegisterNotificationChannelCompleted(MomocloNewsService.RegisterNotificationChannelResult result, Exception error)
        {
            if (!IsBusy)
            {
                return;
        ...
        private void UnregisterNotificationChannelCompleted(MomocloNewsService.UnregisterNotificationChannelResult result, Exception error)
        {
            if (!IsBusy)
            {
                return;
